...
import com.hangdaoju.core.Tools;
...
public class EHCacheUtil {
	  private static CacheManager cacheManager = null;  
	    ...
	    static{  
	        ...
	        try {
	        	cache = EHCacheUtil.initMyCache("person",2,2);
			} catch (Exception e) {
...
//	                config.setTimeToIdleSeconds(timeToIdleSeconds);  
	    ...
	    public static Cache initCache(String cacheName, long timeToLiveSeconds,long TIMETOIDLESECONDS) throws Exception {  
	        return EHCacheUtil.initCache(cacheName, EHCacheConfig.MAXELEMENTSINMEMORY, EHCacheConfig.OVERFLOWTODISK,  
	    ...
	    public static Cache initMyCache(String cacheName,long timeToLiveSeconds,long TIMETOIDLESECONDS) throws Exception{
	    	return EHCacheUtil.initCache(cacheName, timeToLiveSeconds,TIMETOIDLESECONDS);
	    }
	    /** 
	     * 修改缓存容器配置 
	     *  
	    ...
	    public static boolean modifyCache(String cacheName, long timeToLiveSeconds, int maxElementsInMemory) throws Exception {  
	        try {  
	            if (!Tools.isNullOrEmptyString(cacheName) && timeToLiveSeconds != 0L && maxElementsInMemory != 0) {  
