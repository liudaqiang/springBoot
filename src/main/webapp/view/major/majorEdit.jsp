			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							专业管理 <small> <i class="icon-double-angle-right"></i> 专业修改
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form"
								<c:if test="${major != null}">action="${ctx}/admin/major/update"</c:if>
								<c:if test="${major == null}">action="${ctx}/admin/major/add"</c:if>
								method="POST">
								<input type="hidden" value="${major.id}" name="id">
								<input type="hidden" value="4" name="dictType">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="请输入专业名称"
											name="name" value="${major.name}"
