				...
				<div class="page-content">
					<div class="page-header">
						<h1 style="display: inline-block;">
							专业管理 <small> <i class="icon-double-angle-right"></i> 专业列表
							</small>
						</h1>
						<button class="btn btn-primary btn-sm"
							style="float: right; margin-right: 30px;"
							onclick="javascript:window.location.href='${ctx}/admin/major/edit'">创建专业</button>
					</div>
					<!-- /.page-header -->
					<div class="row">
						<div class="col-xs-12">
								...
								<div class="col-xs-12">
									<div class="table-responsive">
										<table id="sample-table-1"
											...
											<tbody>
												<c:forEach items="${majorList}"
													var="major">
													<tr>
														<td>${major.id}</td>
														<td>${major.dictType}</td>
														<td class="hidden-480">${major.name}</td>
														<td>
															<div
																class="visible-md visible-lg hidden-sm hidden-xs btn-group">

																<button class="btn btn-xs btn-info"
																	onclick="javascript:window.location.href='${ctx}/admin/major/edit?id=${major.id}'">
																	<i class="icon-edit bigger-120"></i>
																</button>

																<button class="btn btn-xs btn-danger"
																	onclick="deletePerson('${major.id}')">
