				...
				<div class="page-content">
					<div class="page-header">
						<h1 style="display: inline-block;">
							农民工管理 <small> <i class="icon-double-angle-right"></i> 农民工列表
							</small>
						</h1>
						<button class="btn btn-primary btn-sm"
							style="float: right; margin-right: 30px;"
							onclick="javascript:window.location.href='${ctx}/admin/migrantWorker/edit'">创建农民工</button>
					</div>
					<!-- /.page-header -->
					<div class="row">
						<div class="col-xs-12">
								...
								<div class="col-xs-12">
									<div class="table-responsive">
										<table id="sample-table-1"
											...
											<tbody>
												<c:forEach items="${migrantWorkerList}"
													var="migrantWorker">
													<tr>
														<td>${migrantWorker.id}</td>
														<td>${migrantWorker.name}</td>
														<td>
															<div
																class="visible-md visible-lg hidden-sm hidden-xs btn-group">

																<button class="btn btn-xs btn-info"
																	onclick="javascript:window.location.href='${ctx}/admin/migrantWorker/edit?id=${migrantWorker.id}'">
