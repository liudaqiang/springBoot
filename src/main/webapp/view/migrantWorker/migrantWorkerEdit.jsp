			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							后缀管理 <small> <i class="icon-double-angle-right"></i> 后缀修改
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form"
								<c:if test="${suffix != null}">action="${ctx}/admin/suffix/update"</c:if>
								<c:if test="${suffix == null}">action="${ctx}/admin/suffix/add"</c:if>
								method="POST">
								<input type="hidden" value="${suffix.id}" name="id">
								<input type="hidden" value="6" name="dictType">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="请输入后缀名称"
											name="name" value="${suffix.name}"
