...
<div class="navbar navbar-default" id="navbar">
			...
			<div class="hdj-head">
			<h4><img src="${ctxStatic}/img/hdj1.jpg" alt="" /><span>项目管理系统</span></h4>
		     </div>
