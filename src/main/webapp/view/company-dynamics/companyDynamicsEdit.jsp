			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							动态管理 <small> <i class="icon-double-angle-right"></i> 动态修改
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form"
								<c:if test="${companyDynamics != null}">action="${ctx}/admin/companyDynamics/update"</c:if>
								<c:if test="${companyDynamics == null}">action="${ctx}/admin/companyDynamics/add"</c:if>
								method="POST">
								<input type="hidden" value="${companyDynamics.id}" name="id">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input name="title" type="text" class="col-xs-10 col-sm-5"
											id="form-input-readonly" value="${companyDynamics.title}" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="请输入公司地址"
											name="subTitle" value="${companyDynamics.subTitle}"
								...
								<div class="form-group">
									...
									<div id="sample" class="col-sm-9">
										...
										<textarea name="content" style="width: 500px; height: 100px; overflow:scroll;">${companyDynamics.content}</textarea>
									</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="form-field-2"> 所属公司</label>

									<div class="col-sm-9">
										<select class="col-xs-10 col-sm-5 chosen-select"
											id="form-field-select-3" data-placeholder="选择公司"
											name="companyId">
											<c:forEach items="${companyList}" var="oneCompany">
												<option value="${oneCompany.id}"
													<c:if test="${oneCompany.id == company.parentId}">selected="selected"</c:if>>${oneCompany.name}</option>
											</c:forEach>
										</select>
									</div>
								</div>
