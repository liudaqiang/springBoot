...
<html lang="en">
	...
	<body>
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" <c:if test="${company != null}">action="${ctx}/admin/company/update"</c:if><c:if test="${company == null}">action="${ctx}/admin/company/add"</c:if> method="POST">
									<input type="hidden" value="${company.id}" name="id">

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 公司或部门名 </label>

										<div class="col-sm-9">
											<input  name="name"  type="text" class="col-xs-10 col-sm-5" id="form-input-readonly" value="${company.name}" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="请输入地址" name="address" value="${company.address}" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"
											for="form-field-2"> 类型 *</label> <select
											class="col-xs-10 col-sm-5 chosen-select"
											id="form-field-select-3" data-placeholder="选择类型"
											name="companyType">
											<option value="1" <c:if test="${company.companyType == '1'}">select="select"</c:if>>公司</option>
											<option value="2" <c:if test="${company.companyType == '2'}">select="select"</c:if>>部门</option>
										</select>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="col-xs-10 col-sm-5 limited" id="form-field-5" maxlength="50" name="description">${company.description}</textarea>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 父公司</label>

										<div class="col-sm-9">
											<select class="col-xs-10 col-sm-5 chosen-select" id="form-field-select-3" data-placeholder="Choose a Country..." name="parentId">
												<c:forEach items="${companyList}" var="oneCompany">
													<option value="${oneCompany.id}" <c:if test="${oneCompany.id == company.parentId}">selected="selected"</c:if>>${oneCompany.name}</option>
												</c:forEach>
											</select>
										</div>
									</div>
		...
		<script src="${ctxStatic}/assets/js/date-time/bootstrap-timepicker.min.js"></script>
