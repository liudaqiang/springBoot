			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							标段管理 <small> <i class="icon-double-angle-right"></i> 标段修改
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form"
								<c:if test="${section != null}">action="${ctx}/admin/section/update"</c:if>
								<c:if test="${section == null}">action="${ctx}/admin/section/add"</c:if>
								method="POST">
								<input type="hidden" value="${section.id}" name="id">
								<input type="hidden" value="7" name="dictType">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="请输入标段名称"
