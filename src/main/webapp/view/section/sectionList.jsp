				...
				<div class="page-content">
					<div class="page-header">
						<h1 style="display: inline-block;">
							标段管理 <small> <i class="icon-double-angle-right"></i> 标段列表
							</small>
						</h1>
						<button class="btn btn-primary btn-sm"
							style="float: right; margin-right: 30px;"
							onclick="javascript:window.location.href='${ctx}/admin/section/edit'">创建标段</button>
					</div>
					<!-- /.page-header -->
					<div class="row">
						<div class="col-xs-12">
								...
								<div class="col-xs-12">
									<div class="table-responsive">
										<table id="sample-table-1"
											...
											<tbody>
												<c:forEach items="${sectionList}"
													var="section">
													<tr>
														<td>${section.id}</td>
														<td>${section.dictType}</td>
														<td class="hidden-480">${section.name}</td>
														<td>
															<div
																class="visible-md visible-lg hidden-sm hidden-xs btn-group">

																<button class="btn btn-xs btn-info"
																	onclick="javascript:window.location.href='${ctx}/admin/section/edit?id=${section.id}'">
																	<i class="icon-edit bigger-120"></i>
																</button>

																<button class="btn btn-xs btn-danger"
																	onclick="deletePerson('${section.id}')">
