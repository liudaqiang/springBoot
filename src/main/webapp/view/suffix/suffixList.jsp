...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
				...
				<div class="page-content">
					<div class="page-header">
						<h1 style="display: inline-block;">
							后缀管理 <small> <i class="icon-double-angle-right"></i> 后缀列表
							</small>
						</h1>
						<button class="btn btn-primary btn-sm"
							style="float: right; margin-right: 30px;"
							onclick="javascript:window.location.href='${ctx}/admin/suffix/edit'">创建后缀</button>
					</div>
					<!-- /.page-header -->
					<div class="row">
						<div class="col-xs-12">
								...
								<div class="col-xs-12">
									<div class="table-responsive">
										<table id="sample-table-1"
											...
											<tbody>
												<c:forEach items="${suffixList}"
													var="suffix">
													<tr>
														<td>${suffix.id}</td>
														<td>${suffix.dictType}</td>
														<td class="hidden-480">${suffix.name}</td>
														<td>
															<div
																class="visible-md visible-lg hidden-sm hidden-xs btn-group">

																<button class="btn btn-xs btn-info"
																	onclick="javascript:window.location.href='${ctx}/admin/suffix/edit?id=${suffix.id}'">
																	<i class="icon-edit bigger-120"></i>
																</button>

																<button class="btn btn-xs btn-danger"
																	onclick="deletePerson('${suffix.id}')">
			...
			<script type="text/javascript">
				function deletePerson(suffixId) {
					$
							.confirm({
								title : '是否确定删除?',
								content : '删除后数据将无法恢复',
